    ...
    if (state.stage === 'START') {
        ...
        app.innerHTML = `
            <div class="fade-in flex flex-col items-center justify-center p-12 bg-white rounded-3xl shadow-xl border-b-8 border-gray-100">
                ...
                <h2 class="text-xl font-bold text-gray-800 uppercase text-center">Gerando com Gemini 3.1 Lite...</h2>
            </div>`;
    }
        ...
        app.innerHTML = `
            <div class="fade-in space-y-6 text-center">
                ...
                <button onclick="voltarInicio()" class="w-full text-gray-400 font-bold py-2 mt-2">🏠 INÍCIO</button>
            </div>`;
    }
}
...
async function gerarQuestaoIA() {
    ...
    try {
        // IMPORTANTE: O caminho deve coincidir com o local do arquivo na Vercel
